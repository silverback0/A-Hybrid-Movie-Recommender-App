...
User searches or rates movies
Flask API processes recommendation requests
Hybrid recommendation engine generates personalized suggestions
Results are displayed in the Flutter application
Dataset
